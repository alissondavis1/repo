...
public class CaixaCompletoTableModel extends AbstractTableModel{
    ...
    private List<RcCaixaCompleto> linhas;
    
    public CaixaCompletoTableModel() {
        linhas = new ArrayList<>();
    }
    
    public CaixaCompletoTableModel(List<RcCaixaCompleto> listaDoCaixa) {
    ...
    RcCaixaCompleto c = linhas.get(rowIndex);
...
//      
 //    }
    ...
    public RcCaixaCompleto getLinha(int indiceLinha) {
        return linhas.get(indiceLinha);
    }
 
    // Adiciona o sócio especificado ao modelo
    public void addLinha(RcCaixaCompleto caixa) {
    // Adiciona o registro.
    linhas.add(caixa);
    ...
    public void addListaDeCaixa(List<RcCaixaCompleto> caixaLinha) {
